package devguideocp.Part2_C16to20.A18_1_Localization;
...
public class UsingResourceBundles {
    ...
    public static final Locale[] locales = {
            ...
            Locale.of("no", "NO"),             // Norway (Norwegian)
    ...
    private static void setLocaleSpecificData(Locale locale) {              // (4)
        ...
        ResourceBundle properties =
                ResourceBundle.getBundle("devguideocp.Part2_C16to20.A18_1_Localization.BasicResources", locale);     // (5)
