...
public class ChoicePatternUsage {
    ...
    static void displayMessages(Locale requestedLocale) {
        ...
        ResourceBundle bundle =
                ResourceBundle.getBundle("devguideocp.Part2_C16to20.A18_2_FormattingParsing.ChoiceBundle", requestedLocale);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("@@@@@@@@@@@@@@@@@");
        ResourceBundle bundle =
                ResourceBundle.getBundle("devguideocp.Part2_C16to20.A18_2_FormattingParsing.ChoiceBundle");

        MessageFormat messageFormat = new MessageFormat(bundle.getString("choice.pattern"));
        for (int i=0;i<5;i++){
            System.out.println(messageFormat.format(i));
        }
