package devguideocp.Part1_C1to5.A5_3_OOP_Inheritance3;
...
class NeonLight extends TubeLight {
    ...
    public void demonstrate()                       // (11)
        ...
        ((Light) this).energyCost(50);                // (15) Invokes method at (7) which is inherited and is using runtime/dynamic type, not ref type Light
        System.out.println(((Light) this).getClass());


        System.out.println(super.lightType);          // (16) Accesses field at (6)
        System.out.println(((Light) this).lightType); // (17) Accesses field at (1) //field access is done based on ref type
