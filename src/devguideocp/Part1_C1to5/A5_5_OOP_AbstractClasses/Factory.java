package devguideocp.Part1_C1to5.A5_5_OOP_AbstractClasses;
...
class TubeLight extends Light {
    ...
    // Implementation of the abstract method from the superclass. note it does not throw!
...
//  Light porchLight = new Light(21, true, "Porch");    // (5) Compile-time error!
        ...
        System.out.printf("Energy cost ($): %2.2f%n",
                cellarLight.energyCost(10));               // (7) Using subclass reference
        Light nightLight = new TubeLight(15, false, "Bedroom", 850, 15);     // (8)
        System.out.printf("Energy cost ($): %2.2f%n",
                nightLight.energyCost(20));             // (9) Using superclass reference
